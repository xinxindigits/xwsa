...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='群聊详情表';
...
CREATE TABLE `role_resource` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='角色与资源';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户与组织关系表';
