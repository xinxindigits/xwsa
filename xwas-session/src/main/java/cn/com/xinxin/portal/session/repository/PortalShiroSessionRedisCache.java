 ...
 * @description:
 */
public class PortalShiroSessionRedisCache<K,V> implements Cache<K,V> {

    private static final Logger log = LoggerFactory.getLogger(PortalShiroSessionRedisCache.class);
    ...
    public PortalShiroSessionRedisCache(RedisTemplate sessionRedisTemplate, String name) {
        this.sessionRedisTemplate = sessionRedisTemplate;
        this.cacheKey = PortalSessionConstants.SHIRO_USER_CACHE_KEY + name + ":";
    }
    ...
    public void clear() throws CacheException {
        sessionRedisTemplate.delete(PortalSessionConstants.SHIRO_USER_CACHE_KEY + "*");
    }

    @Override
    public int size() {
        Long size = sessionRedisTemplate.opsForValue().size(PortalSessionConstants.SHIRO_USER_CACHE_KEY + "*");
        return size.intValue();
    }

    @Override
    public Set<K> keys() {
        Set keys = sessionRedisTemplate.keys(PortalSessionConstants.SHIRO_USER_CACHE_KEY + "*");
